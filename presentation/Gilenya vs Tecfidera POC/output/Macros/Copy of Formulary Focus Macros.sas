...
data temp;
 ...
 /* Set Tier equal to that in data , if missing, set to 10 */

    tier_num = input(tier,3.);
	if tier_num = . then tier_num = 10;
run;
...
data temp;
	...
	array statuscode{11} statuscode101-statuscode111; 
	array tiercode{10} tiercode1-tiercode10; 

	retain  formcode101-formcode130;
	retain statuscode101-statuscode111;
	retain tiercode1-tiercode10; 
	by 
...
Data Temp2;
set temp2;
if Formulary_status='DISC UNK' and Code=117 then Formulary_status='PREFER';
if Formulary_status='DISC UNK' and Code=118 then Formulary_status='NON FRM';
if Formulary_status='DISC UNK' and Code=119 then Formulary_status='NO REIM';
run;
...
data temp;
	...
	array roll_statuscode{11} roll_statuscode101-roll_statuscode111; 
	array roll_tiercode{10} roll_tiercode1-roll_tiercode10; 
	...
	retain roll_statuscode101-roll_statuscode111; 
	retain roll_tiercode1-roll_tiercode10; 
	...
	drop	formcode101-formcode133 
			statuscode101-statuscode111 
			tiercode1-tiercode10
			i j k;
run;
...
data temp;
	...
	array roll_statuscode{11} roll2_statuscode101-roll2_statuscode111; 
	array roll_tiercode{10} roll2_tiercode1-roll2_tiercode10; 
	
	array formcode{33}  roll_formcode101-roll_formcode133; 
	array statuscode{11} roll_statuscode101-roll_statuscode111; 
	array tiercode{10} roll_tiercode1-roll_tiercode10; 

	retain roll2_formcode101-roll2_formcode133; 
	retain roll2_statuscode101-roll2_statuscode111; 
	retain roll2_tiercode1-roll2_tiercode10; 
	...
	drop	roll_formcode101-roll_formcode133
			...
			roll_tiercode1-roll_tiercode10
			i j k;
run;
...
Data %str(&Datadirname).Prod_&Dataname(drop=i);
...
Array A(10) roll_tiercode1-roll_tiercode10;
Do i=1 to 10;
...
/* Step 3: (To be added): Use prod_notes_codes to fill in missing tiers if possible */
