...
Merge DataDir.Individual_&prod (in = in1) Temp_&i.(in = in2);
...
Proc means data=temp2_&i. noprint ;
var p1-p&tiers;
by ID scenario;
ID &keepers;
output out=IND_Probs_&prod._&i. mean=; 
run;
*rsubmit;
...
set IND_Probs_&prod._1-IND_Probs_&prod._&IDs.;
run;
